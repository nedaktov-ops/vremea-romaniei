...
class PreferencesDataStore(private val context: Context) {
    ...
    companion object {
        ...
        val RADAR_LAYER = stringPreferencesKey("radar_layer")
    }
    ...
    val settingsFlow: Flow<AppSettings> = context.dataStore.data.map { prefs ->
        AppSettings(
            ...
            radarLayer = prefs[RADAR_LAYER] ?: "clouds"
        )
    }
    ...
    suspend fun updateRadarLayer(layer: String) {
        context.dataStore.edit { prefs ->
            prefs[RADAR_LAYER] = layer
        }
    }
}
